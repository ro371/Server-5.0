...
public class BuyCommand {
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("buy")
				...
				.then(Commands.argument("arguments", StringArgumentType.greedyString()).executes(BuyCommand::execute)).executes(BuyCommand::execute));
	}
	...
	private static int execute(CommandContext<CommandSourceStack> ctx) {
		...
		BuyCommandExecutedProcedure.execute(world, x, y, z, entity);
		return 0;
	}
}
