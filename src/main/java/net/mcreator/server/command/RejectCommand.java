...
public class RejectCommand {
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("reject")

				.then(Commands.argument("arguments", StringArgumentType.greedyString()).executes(RejectCommand::execute))
				.executes(RejectCommand::execute));
	}
	...
	private static int execute(CommandContext<CommandSourceStack> ctx) {
		...
		RejectCommandExecutedProcedure.execute(world, x, y, z);
		return 0;
	}
}
