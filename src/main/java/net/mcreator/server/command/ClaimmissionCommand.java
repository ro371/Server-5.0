...
public class ClaimmissionCommand {
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("claimmission")

				.then(Commands.argument("arguments", StringArgumentType.greedyString()).executes(ClaimmissionCommand::execute))
				.executes(ClaimmissionCommand::execute));
	}
	...
	private static int execute(CommandContext<CommandSourceStack> ctx) {
		...
		ClaimmissionCommandExecutedProcedure.execute(entity);
		return 0;
	}
}
