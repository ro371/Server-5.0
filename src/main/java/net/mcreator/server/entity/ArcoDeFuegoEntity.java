...
package net.mcreator.server.entity;
...
public class ArcoDeFuegoEntity extends AbstractArrow implements ItemSupplier {
	...
	public ArcoDeFuegoEntity(EntityType<? extends ArcoDeFuegoEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public ArcoDeFuegoEntity(EntityType<? extends ArcoDeFuegoEntity> type, LivingEntity entity, Level world) {
