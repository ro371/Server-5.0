...
public class SellguiScreen extends AbstractContainerScreen<SellguiMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Vendes", 15, 11, -12829636);
		this.font.draw(poseStack, "de", 88, 11, -12829636);
		this.font.draw(poseStack, "A cambio de", 13, 37, -12829636);
		this.font.draw(poseStack, "de", 104, 36, -12829636);
	}
