...
public class ServerV5ModMenus {
	...
	public static final MenuType<BarrilGUIMenu> BARRIL_GUI = register("barril_gui", (id, inv, extraData) -> new BarrilGUIMenu(id, inv, extraData));
