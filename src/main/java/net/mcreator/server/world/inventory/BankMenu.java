...
public class BankMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public void removed(Player playerIn) {
		...
		BankThisGUIIsClosedProcedure.execute(entity);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof BankMenu) {
			Level world = entity.level;
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();

			BankWhileThisGUIIsOpenTickProcedure.execute(entity);
		}
	}
}
