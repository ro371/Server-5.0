...
public class ArcoDeFuegoItem extends Item {
	public ArcoDeFuegoItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					ArcoDeFuegoEntity entityarrow = ArcoDeFuegoEntity.shoot(world, entity, world.getRandom(), 1.2000000000000002f, 5.4, 4);
