...
package net.mcreator.server.fluid.attributes;
...
public class AGUACALIENTEFluidAttributes extends FluidAttributes {
	public static CustomBuilder builder(ResourceLocation stillTexture, ResourceLocation flowingTexture) {
		return new CustomBuilder(stillTexture, flowingTexture, AGUACALIENTEFluidAttributes::new);
	}
	...
	protected AGUACALIENTEFluidAttributes(Builder builder, Fluid fluid) {
		super(builder, fluid);
	}
